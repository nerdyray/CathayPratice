...
// 導入要測試的 ConfirDelete 組件
import { ConfirDelete } from './confir-delete';

/**
 * 針對 ConfirDelete 組件的測試套件。
 * `describe` 函數用於定義一個測試套件，包含一系列相關的測試。
 */
describe('ConfirDelete', () => {
  let component: ConfirDelete; // 聲明組件實例變量
  let fixture: ComponentFixture<ConfirDelete>; // 聲明組件的測試夾具
